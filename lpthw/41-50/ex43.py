...
class CenterCorridor(Scene):
    ...
    def enter(self):
        ...
        print("your entire crew. You are the last survived member and your last")
        ...
        if action == "shoot!":
            ...
            print("You wake up shorly after only to die as the Gothon stomps on")
...
class EscapePod(Scene):
    ...
    def enter(self):
        ...
        if int(guess) != good_pod:
            print("You jump into pod %s and hit the eject buttom." % guess)
